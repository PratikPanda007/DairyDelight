...
import { MilkOff, Leaf, Award, ChevronRight } from "lucide-react";
          ...
          <div ref={valuesRef} className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md">
              <div className="w-12 h-12 rounded-full bg-dairy-100 dark:bg-dairy-900/50 flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-dairy-600 dark:text-dairy-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12a4 4 0 100-8 4 4 0 000 8z" />
                </svg>
              </div>
      ...
      <section className="py-16 bg-dairy-600 dark:bg-dairy-800">
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link to="/products">
              <Button size="lg" variant="outline" className="bg-white text-dairy-600 hover:bg-white/90">
                Shop Now
              </Button>
            </Link>
          </div>
