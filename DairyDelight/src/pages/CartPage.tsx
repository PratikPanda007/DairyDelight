...
export default function CartPage() {
  ...
  const animateQuantityChange = (element: HTMLElement) => {
    gsap.fromTo(
      element,
      { scale: 0.9 },
  ...
  const handleQuantityChange = (productId: string, newQuantity: number, e: React.MouseEvent) => {
    ...
    if (e.currentTarget) {
      animateQuantityChange(e.currentTarget as HTMLElement);
    }
  };
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <div className="flex items-center border rounded-md overflow-hidden">
                      <Button
                        ...
                        onClick={(e) => handleQuantityChange(
                          item.product.id, 
            ...
            <CardContent className="space-y-4">
              ...
              {couponDiscount > 0 && (
                <div className="flex justify-between text-green-600 dark:text-green-400">
                  ...
                  <span>-${(totalPrice * (couponDiscount / 100)).toFixed(2)}</span>
                </div>
              )}
              ...
              <div className="flex justify-between font-semibold text-lg">
                <span>Total</span>
                <span>${(finalPrice + (totalPrice >= 50 ? 0 : 5.99)).toFixed(2)}</span>
              </div>
